...
# GPU time
cmake .. -G Ninja -DCUTLASS_ENABLE_SYCL=ON -DCUTLASS_SYCL_PROFILING_ENABLED=ON -DDPCPP_SYCL_TARGET=intel_gpu_pvc -DCUTLASS_ENABLE_BENCHMARKS=ON -DCMAKE_BUILD_TYPE=Release \
...
ninja $target && \
$target --m=4096 --n=4096 --k=4096 --l=1 --iterations=20 --flush_cache=1 --warmup=10 --l3_cache_size=32
